package Dominio;
    ...
    public ProductoDominio(int idProducto, String nombre, String descripcion , double precio , int idCategoria , String categoria , String estadoProducto , byte[] fotoProducto, String fotoProductoString){
